# BigDeal + AWS S3 with Node.JS

A simple and fully working example of BigDeal and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @BigDeal-example/aws-nodejs start
```
